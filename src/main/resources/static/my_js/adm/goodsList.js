        ...
        success:function (d) {
            ...
            for (var i=0;i<d.length;i++) {
                ...
                html += "<tr>" +
                    ...
                    "<td data-title='类型' class='text-info col-sm-1 t" + i + "-goods_type' style='text-align: center'></td>" +
                    ...
                    "<td data-title='店铺名' class='col-sm-1 t" + i + "-store_name' style='text-align: center'></td>" +
